...
import (
	...
	grpc "gitlab.com/market_mc/market_go_product_service/grpc"
	"gitlab.com/market_mc/market_go_product_service/grpc/client"
	"gitlab.com/market_mc/market_go_product_service/pkg/logger"
	"gitlab.com/market_mc/market_go_product_service/storage/postgres"
)
...
func main() {
	...
	log.Info("GRPC: Server being started...", logger.String("port", cfg.ProductGRPCPort))
