...
// All implementations should embed UnimplementedBranchProductServiceServer
...
// UnimplementedBranchProductServiceServer should be embedded to have forward compatible implementations.
