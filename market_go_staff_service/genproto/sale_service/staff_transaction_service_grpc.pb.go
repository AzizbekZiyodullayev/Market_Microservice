...
// All implementations should embed UnimplementedStaffTransactionServiceServer
...
// UnimplementedStaffTransactionServiceServer should be embedded to have forward compatible implementations.
